...
namespace WebSonHal.Controllers
{
    ...
    public class YorumController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Soyad,Email,YorumIcerik,YaziId")] Yorum yorum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Soyad,Email,YorumIcerik,YaziId")] Yorum yorum)
        {
            if (id != yorum.Id)
            {
                return NotFound();
