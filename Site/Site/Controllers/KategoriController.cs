...
namespace Site.Controllers
{
    public class KategoriController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryName")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryName")] Kategori kategori)
        {
            if (id != kategori.Id)
            {
                return NotFound();
